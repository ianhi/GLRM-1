...
class Reg(object):
    ...
    def __init__(self, nu=1):
        self.nu = nu  # XXX think of a better way to handle nu?

    def __str__(self):
        return "GLRM Reg: override me!"
...
class QuadraticReg(Reg):
    def reg(self, X):
        return self.nu * cp.sum_squares(X)

    def __str__(self):
        return "quadratic reg"
